        ...
        <div className="row row-cols-1 p-1 g-2">
          {products.map((product) => (
            <div id="pdc" className="col-4" key={product.model_number}>
              <div className="card">
                <Link className='tpimg' to={`/womens/${product.model_number}`} style={{ textDecoration: 'none' }}>
                  <img
                    src={hoveredImage[product.model_number] || `https://13-century.com/files/womens/${product.model_number}/${product.variants[0]?.color}.png`}
                    ...
                    {product.variants.map((variant) => (
                      <div
                        ...
                        onMouseEnter={() => setHoveredImage((prev) => ({
                          ...prev,
                          [product.model_number]: `https://13-century.com/files/womens/${product.model_number}/${variant.color}.png`
                        }))}
                        onMouseLeave={() => setHoveredImage((prev) => ({
                          ...prev,
                          [product.model_number]: `https://13-century.com/files/womens/${product.model_number}/${product.variants[0]?.color}.png`
                        }))}
                      >
                        <img
                          src={`https://13-century.com/files/womens/${product.model_number}/${variant.color}.png`}
                          alt={variant.color}
                          loading='lazy'
                        />
                      </div>
